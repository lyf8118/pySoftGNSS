...
--------------------------------
GPS L1 C/A code and carrier tracking.
...
class TrackingEngine():
    """Perform GPS L1 C/A code and carrier tracking.
    ...
    def trkChannelsSerial(self, acqResults, corrEngine):
        ...
        for channelNr in range(TrackedNr):
            ...
            # Generate one bipolar C/A-code value per chip.
            codeChips = generateCAcode(settings,chResults.PRN)
    ...
    def trkChannelsParallel(self, acqResults, corrEngine):
        ...
        # Absolute zero-based sample of the next C/A-code start in the record.
        ...
        # Each row contains [last chip, one C/A period, first chip].
        ...
        for channelNr in range(channelCnt):
            ...
            # Generate one C/A-code value per chip.
            caCode = generateCAcode(settings, chResults.PRN)
        ...
        #%% Initialize tracking variables =================================
        # Number of code periods to process; one GPS C/A period is 1 ms.
        ...
        # Number of logical samples per C/A-code period and per second.
