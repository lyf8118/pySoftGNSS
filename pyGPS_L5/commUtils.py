...
def calcCNoPld(chResults, settings, loopCnt):
    """Calculate data, pilot, and combined-signal C/N0 values.

    The variance-summing method estimates C/N0 for the data and pilot
    channels. The narrowband-power ratio supplies one PLL lock-detector
    ...
    -------
        CNo         - numpy.ndarray
                    Data, pilot, and combined C/N0 values in dB-Hz.
    ...
    # The L5Q prompt is stored in the quadrature-rotated orientation used
    # by the MATLAB Calc_CNo_PLD implementation.
...
def calculatePseudoranges(trackResults, subFrameStart, TOW, currMeasSample,
    ...
    ----
        ...
        subFrameStart - array-like
                      ...
                      L5 primary-code periods from the start of tracking.
        TOW           - array-like
