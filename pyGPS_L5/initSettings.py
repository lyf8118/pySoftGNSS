...
------------------------------------
Initialize and save GPS L5 receiver settings.
...
class Settings(object):
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process at least 24 s plus tracking transients so complete CNAV
        ...
        # Number of chips in one L5 primary-code period.
        ...
        # Enable tracking using the L5Q pilot component.
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one L5-code period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete L5-code periods of the input signal.
