...
------------------------------------
Initialize and save Galileo E5b receiver settings.
...
class Settings(object):
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process 60 s so complete Galileo I/NAV pages are available.
        ...
        # Number of chips in one E5bI/E5bQ primary-code period.
        self.codeLength         = 10230           # [chips]
        self.carrFreqBasis      = 1207.14e6       # [Hz]
        self.signalName         = "Galileo E5b"
        self.codeSubchips       = 1
        self.fineAcqPeriods     = 200
        self.acqReadCodePeriods = 202
        self.removeMean         = True
        ...
        self.acqSatelliteList   = np.arange(1,37)    # [PRN numbers]
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one E5b code period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete E5b-code periods of the input signal.
