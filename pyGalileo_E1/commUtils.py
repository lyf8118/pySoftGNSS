...
def calcCNoPld(chResults, settings, loopCnt):
    ...
    -------
        CNo          - numpy.ndarray
                      Data, pilot, and whole E1-signal C/N0 in dB-Hz.
    ...
    # C/N0 estimation for the complete Galileo E1 signal.
...
def calculatePseudoranges(trackResults, subFrameStart, TOW, currMeasSample,
    ...
    ----
        ...
        subFrameStart - array-like
                      Zero-based first-preamble positions counted in 4 ms
                      Galileo E1 primary-code periods from the start of
                      tracking.
        TOW           - array-like
