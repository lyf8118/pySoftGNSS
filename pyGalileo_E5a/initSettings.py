...
------------------------------------
Initialize and save Galileo E5a receiver settings.
...
class Settings(object):
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process 59 s so complete Galileo F/NAV pages are available.
        self.msToProcess         = 59000          #[ms]
        ...
        # Number of chips in one E5aI/E5aQ primary-code period.
        self.codeLength         = 10230           # [chips]
        self.carrFreqBasis      = 1176.45e6       # [Hz]
        self.signalName         = "Galileo E5a"
        self.codeSubchips       = 1
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one E5a code period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete E5a-code periods of the input signal.
