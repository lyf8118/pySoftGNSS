...
-----------------------------------
BDS-3 B2b acquisition on CPU or GPU.
...
#%% Acquisition results
class AcqEngine():
    """Perform BDS-3 B2b acquisition and store its results.
    ...
    def __init__(self, settings):
        """Initialize result arrays through the largest configured B2b PRN.
        ...
        # Zero-based B2bI-code phases [samples]; inf means unavailable.
        # Shape: (svNum,).
    ...
    def acqProcessCPU(self):
        ...
        The function searches for BDS-3 B2b signals of all satellites listed
        ...
        # Actual duration represented by one sampled B2bI code period.
        codePeriod = samplesPerCode * ts
        # Number of samples per B2bI code chip
        ...
        # Map the complete 200 ms fine-acquisition interval to B2bI-code chips
        ...
        for PRN in settings.acqSatelliteList:
            # Generate B2bI codes and sample them according to the sampling freq.
            ...
            if self.peakMetric[PRN-1] > settings.acqThreshold :
                ...
                # The original BDS-3 B2b code contains 10230 chips.
                caCode = correlator.generateB2bICode(settings, PRN)
    ...
    def acqProcessGPU(self):
        ...
        # Number of samples in one nominal B2bI code period.
        samplesPerCode = settings.samplesPerCode
        ...
        #--- Variables for fine acquisition -------------------------------
        # Map all 200 ms absolute sample positions to B2bI-code chips once. The
        ...
        #%% Coarse acquisition ============================================
        for PRN in settings.acqSatelliteList:
            # Generate one B2bI period and sample it at the input sample rate.
            caCodeSamples = correlator.codeSampling(settings, PRN, samplesPerCode)
            ...
            if self.peakMetric[PRN-1] > settings.acqThreshold :
                ...
                # Keep one unsampled 10230-chip B2bI period on the GPU.
                caCode = xp.asarray(correlator.generateB2bICode(settings, PRN),
                                    dtype=realDataType)
