...
------------------------------------
Initialize and save BDS-3 B2b receiver settings.
...
class Settings(object):
    """Initialize and store BDS-3 B2b receiver settings.
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process at least 36 s plus tracking transients so complete BCNAV3
        ...
        self.fileName = "../IF_Data_Set/E5b_B2b_B2I.bin"
        ...
        self.IF                 = 1207.14e6 - 1175e6  # [Hz]
        self.samplingFreq       = 79.0e6          # [Hz]

        #%% B2b code parameters ==============================================
        # Nominal rate of the B2bI primary code.
        self.codeFreqBasis      = 10.23e6         # [Hz]
        # Number of chips in one B2bI-code period.
        self.codeLength         = 10230           # [chips]
        # Carrier center frequency.
        self.carrFreqBasis      = 1207.14e6       # [Hz]
        ...
        self.acqSatelliteList   = np.arange(6,59)    # [PRN numbers]
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one B2bI-code period.
        """
    ...
    def probeData(self):
        ...
        with open(self.fileName, 'rb') as fid:
            ...
            # Read ten complete B2bI-code periods of the input signal.
    ...
    def postProcessing(self):
        """Process the raw BDS-3 B2b signal and plot the receiver results.
        ...
        1. Acquire the BDS-3 B2b signals.
