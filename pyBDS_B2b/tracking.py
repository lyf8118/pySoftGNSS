...
--------------------------------
BDS-3 B2b code and carrier tracking.

"""

import numpy as np

from commUtils import WaitBar, CNoVSM, calcLoopCoef

#%% Initialize result structure
class Channel:
    """Store tracking results for one receiver channel.

    The results contain prompt outputs, absolute B2bI-code starting positions,
    and loop observations saved once per coherent integration interval.
    ...
    def __init__(self, settings):
        ...
        self.CNo = np.zeros(cnoCount)

#%% Tracking engine
class TrackingEngine():
    """Perform BDS-3 B2b code and carrier tracking.
    ...
    def trkChannelsSerial(self, acqResults, corrEngine):
        """Perform BDS-3 B2b code and carrier tracking for selected channels.
        ...
        """
        from correlator import generateB2bICode
        ...
        for channelNr in range(TrackedNr):
            ...
            # Generate one bipolar B2bI-code value per chip.
            codeChips = generateB2bICode(settings, chResults.PRN)
    ...
    def trkChannelsParallel(self, acqResults, corrEngine):
        """Perform BDS-3 B2b tracking for all active channels.
        ...
        # Absolute zero-based sample of the next B2bI-code start in the record.
        ...
        # Each row contains [last chip, one B2bI period, first chip].
        ...
        for channelNr in range(channelCnt):
            ...
            # Generate one B2bI-code value per chip.
            caCode = generateB2bICode(settings, chResults.PRN)
        ...
        #%% Initialize tracking variables =================================
        # Number of coherent tracking epochs processed for every active channel.
        numToProcess = trkResults[0].I_P.size
        ...
        # Number of logical samples per B2bI-code period and per second.
    ...
    def trackingRun(self, acqResults):
        """Run BDS-3 B2b code and carrier tracking.
