...
------------------------------------
Initialize and save GLONASS L1/L2 receiver settings.
...
class Settings(object):
    """Store GLONASS L1/L2 receiver settings."""
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process at least 36 s plus tracking transients so complete GLONASS
        # navigation strings are available to navigation decoding.
        ...
        self.fileType           = 2
        # Frequency spacing of adjacent frequency channels: 562.5 kHz for
        # GLONASS L1 and 437.5 kHz for GLONASS L2.
        self.freqSpacing        = 437.5e3         # [Hz]
        # Intermediate, sampling and code frequencies
        self.IF                 = -2.06e6         # [Hz]
        self.samplingFreq       = 30.e6           # [Hz]
        self.codeFreqBasis      = 0.511e6         # [Hz]
        # Number of chips in one GLONASS C/A-code period.
        self.codeLength         = 511             # [Chips]
        ...
        # Frequency channels to look for. Some channels can be excluded to
        # speed up acquisition.
        self.acqSatelliteList   = np.arange(-7,7)    # [Frequency channel K]
        # One-sided band around IF searched for satellite signals.
        self.acqSearchBand      = 5000.              # [Hz]
        # Number of non-coherently combined 1 ms correlation blocks.
        self.acqNonCohTime      = 20                 # [ms]
        ...
        self.useTropCorr        = False           # True - On; False - Off
        ...
        #%% CNo Settings ======================================================
        # Accumulation interval used by the VSM C/N0 estimator.
        self.CNoVSMinterval = 100
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one GLONASS C/A-code
                           period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete GLONASS C/A-code periods.
    ...
    def postProcessing(self):
        """Process the raw GLONASS L1/L2 signal and plot receiver results.
