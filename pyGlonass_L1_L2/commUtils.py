...
def skyPlot(hAxis, az, el, prn, line_style="auto"):
    ...
    ----
        ...
        prn        - array-like
                   Frequency-channel identifiers of the satellites.
        line_style - str
    ...
    # leading blank places the channel identifier beside the final point and
...
def calculatePseudoranges(trackResults, subFrameStart, TOD, currMeasSample,
    ...
    ----
        ...
        subFrameStart - array-like
                      ...
                      C/A-code periods from the start of tracking.
        TOD           - array-like
                      Time of day of the first GLONASS string, in seconds.
        currMeasSample - int
                       Current measurement sample location.
        localTime     - float or None
                      Local GLONASS time at the measurement time.
    ...
    for channelNr in channelList:
        ...
        # then find code phase from the code start to the measurement point.
        ...
        # code period; index-subFrameStart is the integer number of periods.
