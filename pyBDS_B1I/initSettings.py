...
------------------------------------
Initialize and save BDS B1I/B2I receiver settings.
...
class Settings(object):
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process at least 36 s plus tracking transients so complete BDS D1/D2
        # subframes are available to navigation decoding.
        ...
        self.fileName           = "../IF_Data_Set/BDS_B1I.bin"
        ...
        self.IF                 = -0.098e6        # [Hz]
        self.samplingFreq       = 10.0e6          # [Hz]
        self.codeFreqBasis      = 2.046e6         # [Hz]
        # Number of chips in one B1I/B2I-code period.
        self.codeLength         = 2046            # [chips]
        ...
        #%% BDS B1I/B2I carrier frequency ====================================
        # Use 1207.14e6 Hz when this receiver is configured for B2I.
        self.carrFreqBasis = 1561.098e6          # [Hz]
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one B1I/B2I-code period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete B1I/B2I-code periods of the input signal.
