...
-----------------------------------
BDS B1I/B2I acquisition on CPU or GPU.
...
#%% Acquisition results
class AcqEngine():
    """Perform BDS B1I/B2I acquisition and store its results.
    ...
    def __init__(self, settings):
        """Initialize result arrays through the largest configured BDS PRN.
        ...
        # Zero-based B1I/B2I-code phases [samples]; inf means unavailable.
        # Shape: (svNum,).
    ...
    def acqProcessCPU(self):
        ...
        The function searches for BDS B1I/B2I signals of all satellites listed
        ...
        # Actual duration represented by one sampled B1I/B2I code period.
        codePeriod = samplesPerCode * ts
        # Number of samples per B1I/B2I code chip
        ...
        # Map the complete 200 ms fine-acquisition interval to B1I/B2I-code chips
        ...
        for PRN in settings.acqSatelliteList:
            ...
            if self.peakMetric[PRN-1] > settings.acqThreshold :
                ...
                # The original BDS B1I/B2I code contains 2046 chips.
                caCode = correlator.generateB12Icode(settings, PRN)
    ...
    def acqProcessGPU(self):
        ...
        # Number of samples in one nominal B1I/B2I code period.
        samplesPerCode = settings.samplesPerCode
        ...
        #--- Variables for fine acquisition -------------------------------
        # Map all 200 ms absolute sample positions to B1I/B2I-code chips once. The
        ...
        #%% Coarse acquisition ============================================
        for PRN in settings.acqSatelliteList:
            # Generate one B1I/B2I period and sample it at the input sample rate.
            caCodeSamples = correlator.codeSampling(settings, PRN, samplesPerCode)
            ...
            if self.peakMetric[PRN-1] > settings.acqThreshold :
                ...
                # Keep one unsampled 2046-chip B1I/B2I period on the GPU.
                caCode = xp.asarray(correlator.generateB12Icode(settings, PRN),
                                    dtype=realDataType)
