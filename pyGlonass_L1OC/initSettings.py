...
------------------------------------
Initialize and save GLONASS L1OC receiver settings.
...
class Settings(object):
    """Store GLONASS L1OC receiver settings."""
    ...
    def __init__(self):
        ...
        self.fileName           = "../IF_Data_Set/GLO_L1OC_L1.bin"
        ...
        # Equivalent L1OC code frequency and length at the BOC half-chip grid.
        self.codeFreqBasis      = 0.5115e6 * 2    # [Hz]
        self.codeLength         = 1023 * 2
        self.L1OcpCodeLength    = 1023 * 4 * 2
        self.L1OCFineFactor     = 2
        ...
        #%% L1OC carrier frequency ===========================================
        self.carrFreqBasis = 1600.995e6           # [Hz]
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one L1OC data-code
                           period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete L1OCd-code periods of the input signal.
    ...
    def postProcessing(self):
        """Process the raw GLONASS L1OC signal and plot receiver results.
