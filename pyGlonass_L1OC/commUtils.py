...
def calcCNoPld(chResults, settings, loopCnt):
    """Calculate C/N0 and PLL-detector outputs for GLONASS L1OC.

    The variance-summing method estimates C/N0 separately for the data and
    pilot branches. Their linear C/N0 ratios are added for the complete L1OC
    ...
    -------
        CNo         - numpy.ndarray
                    Data, pilot, and complete-L1OC C/N0 values in dB-Hz.
    ...
    #--- C/N0 for the complete L1OC signal -------------------------------
...
def calculatePseudoranges(trackResults, subFrameStart, TOD, currMeasSample,
    ...
    ----
        ...
        subFrameStart - array-like
                      Zero-based first-string positions counted in 2 ms
                      L1OCd-code periods from the start of tracking.
        TOD           - array-like
                      Time of day of the first L1OCd string, in seconds.
        currMeasSample - int
