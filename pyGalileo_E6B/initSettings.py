...
------------------------------------
Initialize and save Galileo E6B/E6C receiver settings.
...
class Settings(object):
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process 50 s so complete Galileo E6B pages are available.
        ...
        self.fileName           = "../IF_Data_Set/GAL_E6.bin"
        ...
        self.codeFreqBasis      = 5.115e6          # [Hz]
        # Number of chips in one E6B/E6C primary-code period.
        self.codeLength         = 5115             # [chips]
        self.carrFreqBasis      = 1278.75e6        # [Hz]
        self.signalName         = "Galileo E6B/E6C"
        self.codeSubchips       = 1
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one E6 code period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete E6-code periods of the input signal.
