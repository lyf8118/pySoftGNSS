...
--------------------------------
BDS B3I code and carrier tracking.
...
class TrackingEngine():
    """Perform BDS B3I code and carrier tracking.
    ...
    def trkChannelsSerial(self, acqResults, corrEngine):
        ...
        """
        from correlator import generateB3Icode
        ...
        for channelNr in range(TrackedNr):
            ...
            # Generate one bipolar B3I-code value per chip.
            codeChips = generateB3Icode(settings, chResults.PRN)
    ...
    def trkChannelsParallel(self, acqResults, corrEngine):
        ...
        # Absolute zero-based sample of the next B3I-code start in the record.
        ...
        # Each row contains [last chip, one B3I period, first chip].
        ...
        for channelNr in range(channelCnt):
            ...
            # Generate one B3I-code value per chip.
            caCode = generateB3Icode(settings, chResults.PRN)
        ...
        #%% Initialize tracking variables =================================
        # Number of code periods to process; one BDS B3I period is 1 ms.
        ...
        # Number of logical samples per B3I-code period and per second.
