...
------------------------------------
Initialize and save BDS B3I receiver settings.
...
class Settings(object):
    ...
    def __init__(self):
        ...
        self.fileName           = "../IF_Data_Set/BDS_B3I.bin"
        ...
        # Number of chips in one B3I-code period.
        ...
        #%% BDS B3I carrier frequency =======================================
        self.carrFreqBasis = 1268.520e6          # [Hz]
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one B3I-code period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete B3I-code periods of the input signal.
