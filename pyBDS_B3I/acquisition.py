...
-----------------------------------
BDS B3I acquisition on CPU or GPU.
...
#%% Acquisition results
class AcqEngine():
    """Perform BDS B3I acquisition and store its results.
    ...
    def __init__(self, settings):
        ...
        # Zero-based B3I-code phases [samples]; inf means unavailable.
        # Shape: (svNum,).
    ...
    def acqProcessCPU(self):
        ...
        The function searches for BDS B3I signals of all satellites listed
        ...
        # Actual duration represented by one sampled B3I code period.
        codePeriod = samplesPerCode * ts
        # Number of samples per B3I code chip
        ...
        # Map the complete 200 ms fine-acquisition interval to B3I-code chips
        ...
        for PRN in settings.acqSatelliteList:
            ...
            if self.peakMetric[PRN-1] > settings.acqThreshold :
                ...
                # The original BDS B3I code contains 10230 chips.
                caCode = correlator.generateB3Icode(settings, PRN)
    ...
    def acqProcessGPU(self):
        ...
        # Number of samples in one nominal B3I code period.
        samplesPerCode = settings.samplesPerCode
        ...
        #--- Variables for fine acquisition -------------------------------
        # Map all 200 ms absolute sample positions to B3I-code chips once. The
        ...
        #%% Coarse acquisition ============================================
        for PRN in settings.acqSatelliteList:
            # Generate one B3I period and sample it at the input sample rate.
            caCodeSamples = correlator.codeSampling(settings, PRN, samplesPerCode)
            ...
            if self.peakMetric[PRN-1] > settings.acqThreshold :
                ...
                # Keep one unsampled 10230-chip B3I period on the GPU.
                caCode = xp.asarray(correlator.generateB3Icode(settings, PRN),
                                    dtype=realDataType)
