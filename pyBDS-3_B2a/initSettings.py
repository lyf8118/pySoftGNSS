...
------------------------------------
Initialize and save BDS-3 B2a receiver settings.
...
class Settings(object):
    """Initialize and store BDS-3 B2a receiver settings.
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process at least 48 s plus tracking transients so complete BCNAV2
        # frames are available to navigation decoding.
        self.msToProcess         = 60000          #[ms]
        # Maximum number of channels used for signal processing.
        self.numberOfChannels    = 20
        ...
        self.fileName           = "../IF_Data_Set/L5_E5a_B2a.bin"
        ...
        #%% B2a code parameters ==============================================
        # Nominal rate of the B2a primary code.
        self.codeFreqBasis      = 10.23e6         # [Hz]
        # Number of chips in one B2a primary-code period.
        self.codeLength         = 10230           # [chips]
        # Carrier center frequency.
        self.carrFreqBasis      = 1176.45e6       # [Hz]
        ...
        self.dllNoiseBandwidth      = 2.0         # [Hz]
        self.dllCorrelatorSpacing   = 0.5        # [chips]
        # Carrier tracking loop parameters
        self.pllDampingRatio        = 0.7
        self.pllNoiseBandwidth      = 15.        # [Hz]
        # Integration time for DLL and PLL
        self.intTime                = 0.001       # [s]
        # Enable/disable use of the pilot channel for tracking.
        self.pilotTRKflag           = 1           # 0 - Off; 1 - On
        ...
        # The average of the nominal MEO and GEO/IGSO travel times.
        self.startOffset       = 94.0

        #%% CNo Settings ======================================================
        # Number of prompt accumulations in each C/N0 estimation window.
        self.CNoVSMinterval = 200
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one B2a-code period.
        """
    ...
    def probeData(self):
        ...
        with open(self.fileName, 'rb') as fid:
            ...
            # Read ten complete B2a-code periods of the input signal.
    ...
    def postProcessing(self):
        """Process the raw BDS-3 B2a signal and plot the receiver results.
        ...
        1. Acquire the BDS-3 B2a signals.
