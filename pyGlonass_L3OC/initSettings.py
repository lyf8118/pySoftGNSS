...
------------------------------------
Initialize and save GLONASS L3OC receiver settings.
...
class Settings(object):
    """Store GLONASS L3OC receiver settings."""
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process enough data to decode L3OCd message types 10, 11 and 12.
        ...
        self.fileName           = "../IF_Data_Set/GLO_L3OC.bin"
        ...
        # Number of chips in one L3OC primary-code period.
        ...
        #%% L3OC carrier frequency ===========================================
        self.carrFreqBasis = 1202.025e6           # [Hz]
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded number of samples in one L3OC code period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete L3OC-code periods of the input signal.
    ...
    def postProcessing(self):
        """Process the raw GLONASS L3OC signal and plot receiver results.
