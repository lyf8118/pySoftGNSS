...
def calcCNoPld(chResults, settings, loopCnt):
    """Calculate C/N0 and PLL-detector outputs for GLONASS L3OC.

    The variance-summing method estimates C/N0 separately for the data and
    pilot branches. Their linear C/N0 ratios are added for the complete L3OC
    signal. The narrowband-power ratio supplies one PLL detector per branch.
    ...
    -------
        CNo         - numpy.ndarray
                    Data, pilot, and complete-L3OC C/N0 values in dB-Hz.
        pllDetector - numpy.ndarray
                    Data- and pilot-branch PLL-detector outputs.
    """
    CNo = np.zeros(3)
    ...
    #--- C/N0 and PLL detector for the data branch -----------------------
    ...
    #--- C/N0 and PLL detector for the pilot branch ----------------------
    pilotCNo = 0.0
    ...
    #--- C/N0 for the complete L3OC signal -------------------------------
...
def calculatePseudoranges(trackResults, subFrameStart, TOD, currMeasSample,
    ...
    ----
        ...
        subFrameStart - array-like
                      Zero-based first-message positions counted in 1 ms
                      L3OCd-code periods from the start of tracking.
        TOD           - array-like
                      Time of day of the first L3OCd message, in seconds.
        currMeasSample - int
                       Current measurement sample location.
        localTime     - float or None
                      Local GLONASS time at the measurement epoch.
    ...
    for channelNr in channelList:
        ...
        transmitTime[channelNr] = (
            ...
            * settings.codeLength / settings.codeFreqBasis + TOD[channelNr])
