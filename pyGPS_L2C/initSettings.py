...
------------------------------------
Initialize and save GPS L2C receiver settings.
...
class Settings(object):
    ...
    def __init__(self):
        ...
        """
        #%% Processing settings ===============================================
        # Process at least 58 s plus tracking transients so complete CNAV
        # messages are available to navigation decoding.
        self.msToProcess         = 58000          #[ms]
        # Maximum number of channels used for signal processing.
        self.numberOfChannels    = 10
        ...
        self.fileName           = "../IF_Data_Set/GPS_L2.bin"
        ...
        # Equivalent CM+CL code rate and length within 20 ms.
        self.codeFreqBasis      = 0.5115e6 * 2     # [Hz]
        self.codeLength         = 10230 * 2        # [chips]
        self.CLCodeLength       = 10230 * 75 * 2   # [chips]
        self.carrFreqBasis      = 1227.60e6        # [Hz]
        ...
        self.intTime                = 0.02        # [s]
        # Enable tracking using the pilot CL component.
    ...
    def samplesPerCode(self):
        ...
        -------
            samplesPerCode - int
                           Rounded samples in one equivalent CM+CL period.
        """
    ...
    def probeData(self):
        ...
        try:
            with open(self.fileName, 'rb') as fid:
                ...
                try:
                    # Read ten complete equivalent CM+CL-code periods.
